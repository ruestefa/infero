...
integer :: i, nx,ny,nz,nt,dim_len(6)
...
call readgrid_1d(nc_name,'cosmu0',cosmu0,dim_len(1),dim_len(6))
call readgrid_2d(nc_name,'temp',temp,dim_len(1),dim_len(3),dim_len(6))
...
CHARACTER(LEN=1024) :: xname, yname, vname
!Open netCDF file
!:-------:-------:-------:-------:-------:-------:-------:-------:
CALL check(nf90_open(TRIM(infile), nf90_nowrite, ncid))
